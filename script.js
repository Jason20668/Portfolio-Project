...
const projectDescriptions = {
  ...
  'street fighter project': 'A game-themed website inspired by the Street Fighter franchise, showcasing character selection, head-to-head stats, and dynamic visual storytelling. This project highlights skills in layout design, responsive styling, and building immersive fan-driven web experiences.',
  ...
  'woplinger project': 'A creative portfolio-style website featuring strong visual hierarchy, expressive typography, and bold layout choices. The Woplinger Project pushes design boundaries with a distinctive aesthetic voice, showcasing an ability to develop unique brand identities through web design.'
};
